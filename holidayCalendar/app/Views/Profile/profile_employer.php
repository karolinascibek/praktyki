            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row py-4">
                        ...
                        <hr>
                        <form action='/profile/edit_name_employer' method='post'>
                    ...
                    <div class="row py-3">
                        ...
                        <hr>
                        <form class='' action='/profile/edit_password_employer' method='post'>
                    ...
                    <div class="row pb-1 ">
                        ...
                        <hr>
                        <form action='/profile/delete_account_employer' method='post' class='my-5 '>
                            <div class="row pl-3 ">
                                <div class="form-group">
